...
- inbound message/trpc events are processed only while wrapper state is OPEN, so pre-connect and post-disconnect transport frames do not leak into message handlers.
